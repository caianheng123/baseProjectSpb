...
// */
//package com.paraview.abf.common.codec;
//
//
//import cn.hutool.core.collection.CollUtil;
//import com.paraview.abf.common.lang.StringUtils;
//
...
//                            if (CollUtil.isNotEmpty(firstKeyBt)) {
//                                tempBt = enc(tempBt, (int[]) firstKeyBt.get(x));
//                            }
//
//                        }
//                        for (y = 0; y < secondLength; y++) {
//                            if (CollUtil.isNotEmpty(secondKeyBt)) {
//                                tempBt = enc(tempBt, (int[]) secondKeyBt.get(y));
//                            }
//
//                        }
//                        for (z = 0; z < thirdLength; z++) {
//                            if (CollUtil.isNotEmpty(thirdKeyBt)) {
